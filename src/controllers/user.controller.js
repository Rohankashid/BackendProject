...
const generateAccessAndRefreshTokens = async (userId) => {
   try {
      ...
      throw new ApiError(500, "Something went wrong while generating frefresh and access token")
   }
}
...
const registerUser = asyncHandler(async (req, res) => {
   ...
   // create user object - create entry in a database
...
const incomingRefreshAccessToken = asyncHandler(async (req, res) => {
